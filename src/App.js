  ...
  equals = () => {
    ...
    if (this.operator === "*") {
      ...
      if (this.tempResult === 0) {
        ...
        this.setState({
          result: Number.isInteger(multiplied)
            ? multiplied
        ...
        <div className="calcTable">
          <div className="calcRow">
            <div className="calcCell">
              <button onClick={this.addItem} value="7" className="buttonBlue">
                7
              </button>
            </div>
            <div className="calcCell">
              <button onClick={this.addItem} value="8" className="buttonBlue">
                8
              </button>
            </div>
            <div className="calcCell">
              <button onClick={this.addItem} value="9" className="buttonBlue">
                9
              </button>
            </div>
            <div className="calcCell">
          ...
          <div className="calcRow">
            <div className="calcCell">
              <button onClick={this.addItem} value="4" className="buttonBlue">
                4
              </button>
            </div>
            <div className="calcCell">
              <button onClick={this.addItem} value="5" className="buttonBlue">
                5
              </button>
            </div>
            <div className="calcCell">
              <button onClick={this.addItem} value="6" className="buttonBlue">
                6
              </button>
            </div>
            <div className="calcCell">
          ...
          <div className="calcRow">
            <div className="calcCell">
              <button onClick={this.addItem} value="1" className="buttonBlue">
                1
              </button>
            </div>
            <div className="calcCell">
              <button onClick={this.addItem} value="2" className="buttonBlue">
                2
              </button>
            </div>
            <div className="calcCell">
              <button onClick={this.addItem} value="3" className="buttonBlue">
                3
              </button>
            </div>
            <div className="calcCell">
          ...
          <div className="calcRow">
            <div className="calcCell">
              <button
                ...
                className="buttonLarge buttonRed"
                value="0"
              >
                0
              </button>
            ...
            <div className="calcCell">
              <button onClick={this.addItem} className="buttonBlue" value=".">
                .
              </button>
            </div>
            <div className="calcCell">
          ...
          <div className="calcRow">
            <div className="calcCell">
              <button onClick={this.clear} className="buttonLarge buttonRed">
                Del
              </button>
            </div>
            <div className="calcCell">
            ...
            <div className="calcCell">
              <button onClick={this.equals} className="buttonRed">
                =
              </button>
            </div>
          </div>
